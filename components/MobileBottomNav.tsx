...
const MobileBottomNav: React.FC<{ onOpenGrievance: () => void }> = ({ onOpenGrievance }) => {
  return (
    <div className="lg:hidden fixed bottom-0 left-0 w-full bg-white border-t border-slate-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-40 pb-safe">
      <div className="flex justify-around items-center h-16">
        ...
        <div className="relative -top-5">
          <button 
            ...
            className="flex flex-col items-center justify-center w-14 h-14 bg-brand-blue text-white rounded-full shadow-lg shadow-brand-blue/40 hover:scale-105 active:scale-95 transition-all border-4 border-slate-50"
