import { 
  ...
  HardHat, Trash2, Calculator, Percent, Key, UserCheck
} from 'lucide-react';
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { 
    ...
    subItems: [
      ...
      { label: 'Trade License', href: '#trade' },
      { label: 'Grievance', href: 'https://grs.ulbharyana.gov.in/' },
...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    description: "Apply for new connections via Saral Haryana.",
    icon: Droplets,
